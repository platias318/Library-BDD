...
public class Borrower  {
    ...
    private Person person = new Person(); // είναι ένα αντικέιμενο Person που του βάζουμε στοιχεία
    private Set<Loan> loans = new HashSet<Loan>(); // σετ με την συλλογή των δανεισμών του δανειζόμενου
    ...
    /**
     * Επιστρέφει το ημερήσιο πρόστιμο για το δανειζόμενο.
     * Επιστρέφει {@code null} αν δεν υπάρχει
     * κατηγορία δανειζομένου ({@link BorrowerCategory})
